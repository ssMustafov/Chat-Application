...
public final class LanguageConstants {
	...
	public static final String START_SERVER_MESSAGE = "start";
	public static final String STOP_SERVER_MESSAGE = "stop";
	public static final String CHOOSE_LANGUAGE_MESSAGE = "chooseLang";
	public static final String CHOOSE_PORT_MESSAGE = "choosePort";
	public static final String SERVER_CLOSED_MESSAGE = "closed";
	public static final String SERVER_STARTED_MESSAGE = "started";
	public static final String ANOTHER_PORT_MESSAGE = "anotherPort";
	public static final String CANNOT_START_MESSAGE = "cannotStart";
